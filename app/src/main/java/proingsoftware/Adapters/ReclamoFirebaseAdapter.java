...
public class ReclamoFirebaseAdapter extends RecyclerView.Adapter<ReclamoFirebaseAdapter.ReclamoViewHolder> {
    ...
    private List<ReclamoFirebase> reclamoList;
    private LayoutInflater inflater;

    public ReclamoFirebaseAdapter (Context context, List<ReclamoFirebase> reclamoList) {
    ...
    public void onBindViewHolder(ReclamoViewHolder reclamoViewHolder, int position) {
        ...
        reclamoViewHolder.textView3.setText(this.reclamoList.get(position).getProducto());
